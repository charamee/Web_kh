...
VALUES(MYMEMBERSEQ.NEXTVAL,'admin','admin1234','차차','부천시','1004-1004','angel@admin.com','Y','ADMIN');

INSERT INTO MYMEMBER 
VALUES(MYMEMBERSEQ.NEXTVAL,'test','test','test','test','test','angeltest@admin.com','Y','USER');
