 ...
 * Generated at: 2021-02-24 07:35:06 UTC
...
public final class mylist_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 response.setContentType("text/html; charset=UTF-8"); 
	...
	List<MVCBoardDto> list = (List<MVCBoardDto>)request.getAttribute("list"); //컨트롤러에서 "list"에 담아놨던거 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("\t<form action=\"Myservlet.do?command=muldel\" method=\"post\" id=\"muldelform\">\r\n");
	...
	for(MVCBoardDto dto : list){
      ...
      out.write("</td>\r\n");
      out.write("\t\t<td><a href=\"Myservlet.do?command=select&seq=");
      out.print(dto.getSeq());
      out.write('"');
      out.write('>');
