...
<body>
	...
	<table border="1">
		...
		<tr>
			<th>내용</th>
			<td><textarea rows="10" cols="50" name="content"><jsp:getProperty property="content" name="dto"/></textarea></td>
		</tr>
		
		<tr>
			<td>
				<input type="submit" value="수정">
				<input type="button" value="취소" onclick="controller.do?command=list">
			</td>
		</tr>
